#!/bin/bash
################################################################################
# Script for Installation: ODOO 8 server on Debian 8
...
#Enter version for checkout "9.0" for version 9.0, "8.0（version 8）7.0 (version 7), saas-4, saas-5 (opendays version) and "master" for trunk
OE_VERSION="9.0"
